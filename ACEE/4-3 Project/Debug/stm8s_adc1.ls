...
2072                     ; 391     temph = (uint16_t)((uint16_t)((uint16_t)templ << 6) | (uint16_t)((uint16_t)temph << 8));
...
2088  0546               L526:
2089                     ; 394   return ((uint16_t)temph);
2091  0546 1e04          	ldw	x,(OFST-1,sp)
2094  0548 5b05          	addw	sp,#5
2095  054a 81            	ret
2142                     ; 405 void ADC1_AWDChannelConfig(ADC1_Channel_TypeDef Channel, FunctionalState NewState)
2142                     ; 406 {
2143                     	switch	.text
2144  054b               _ADC1_AWDChannelConfig:
2146  054b 89            	pushw	x
2147       00000000      OFST:	set	0
2150                     ; 408   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
...
2170  0568               L062:
2171                     ; 409   assert_param(IS_ADC1_CHANNEL_OK(Channel));
...
2244  05da               L356:
2245                     ; 419       ADC1->AWCRL &= (uint8_t)~(uint8_t)((uint8_t)1 << Channel);
...
2262  05f0               L156:
2263                     ; 424     if (NewState != DISABLE)
2265  05f0 0d02          	tnz	(OFST+2,sp)
2266  05f2 2717          	jreq	L166
2267                     ; 426       ADC1->AWCRH |= (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8));
...
2285  060b               L166:
2286                     ; 430       ADC1->AWCRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (uint8_t)(Channel - (uint8_t)8));
...
2307  0621 85            	popw	x
2308  0622 81            	ret
2343                     ; 441 void ADC1_SetHighThreshold(uint16_t Threshold)
2343                     ; 442 {
2344                     	switch	.text
2345  0623               _ADC1_SetHighThreshold:
2347  0623 89            	pushw	x
2348       00000000      OFST:	set	0
2351                     ; 443   ADC1->HTRH = (uint8_t)(Threshold >> (uint8_t)2);
2353  0624 54            	srlw	x
2354  0625 54            	srlw	x
2355  0626 9f            	ld	a,xl
2356  0627 c75408        	ld	21512,a
2357                     ; 444   ADC1->HTRL = (uint8_t)Threshold;
2359  062a 7b02          	ld	a,(OFST+2,sp)
2360  062c c75409        	ld	21513,a
2361                     ; 445 }
2364  062f 85            	popw	x
2365  0630 81            	ret
2400                     ; 453 void ADC1_SetLowThreshold(uint16_t Threshold)
2400                     ; 454 {
2401                     	switch	.text
2402  0631               _ADC1_SetLowThreshold:
2406                     ; 455   ADC1->LTRL = (uint8_t)Threshold;
2408  0631 9f            	ld	a,xl
2409  0632 c7540b        	ld	21515,a
2410                     ; 456   ADC1->LTRH = (uint8_t)(Threshold >> (uint8_t)2);
2412  0635 54            	srlw	x
2413  0636 54            	srlw	x
...
2416                     ; 457 }
2419  063b 81            	ret
2473                     ; 466 uint16_t ADC1_GetBufferValue(uint8_t Buffer)
2473                     ; 467 {
2474                     	switch	.text
...
2482                     ; 468   uint16_t temph = 0;
2484                     ; 469   uint8_t templ = 0;
2486                     ; 472   assert_param(IS_ADC1_BUFFER_OK(Buffer));
2488  063f a10a          	cp	a,#10
2489  0641 2403          	jruge	L613
2490  0643 4f            	clr	a
2491  0644 2010          	jra	L023
2492  0646               L613:
2493  0646 ae01d8        	ldw	x,#472
...
2533  067c               L747:
2534                     ; 486     temph = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1));
...
2544                     ; 488     templ = *(uint8_t*)(uint16_t)((uint16_t)ADC1_BaseAddress + (uint8_t)(Buffer << 1) + 1);
...
2712  0706               L5001:
2713                     ; 515     status = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (Channel - (uint8_t)8)));
...
2735  071c 85            	popw	x
2736  071d 81            	ret
2895                     ; 527 FlagStatus ADC1_GetFlagStatus(ADC1_Flag_TypeDef Flag)
2895                     ; 528 {
2896                     	switch	.text
...
2904                     ; 529   uint8_t flagstatus = 0;
2906                     ; 530   uint8_t temp = 0;
2908                     ; 533   assert_param(IS_ADC1_FLAG_OK(Flag));
...
2996  07a0               L5011:
2997                     ; 550       flagstatus = (uint8_t)(ADC1->AWSRH & (uint8_t)((uint8_t)1 << (temp - 8)));
...
3020  07bd               L1011:
3021                     ; 557   return ((FlagStatus)flagstatus);
3023  07bd 7b01          	ld	a,(OFST+0,sp)
3026  07bf 85            	popw	x
3027  07c0 81            	ret
3072                     ; 567 void ADC1_ClearFlag(ADC1_Flag_TypeDef Flag)
3072                     ; 568 {
3073                     	switch	.text
...
3081                     ; 569   uint8_t temp = 0;
3083                     ; 572   assert_param(IS_ADC1_FLAG_OK(Flag));
...
3331                     ; 630       itstatus = (ITStatus)(ADC1->AWSRL & (uint8_t)((uint8_t)1 << temp));
...
3366  08ff               L7711:
3367                     ; 639     itstatus = (ITStatus)(ADC1->CSR & (uint8_t)ITPendingBit);
3369  08ff c65400        	ld	a,21504
3370  0902 1403          	and	a,(OFST+2,sp)
3371  0904 6b01          	ld	(OFST+0,sp),a
3372  0906               L5021:
3373                     ; 641   return ((ITStatus)itstatus);
...
3497                     ; 675       ADC1->AWSRL &= (uint8_t)~(uint8_t)((uint8_t)1 << temp);
...
3515  0991               L3321:
3516                     ; 679       ADC1->AWSRH &= (uint8_t)~(uint8_t)((uint8_t)1 << (temp - 8));
...
3534  09a9               L1321:
3535                     ; 684     ADC1->CSR &= (uint8_t)((uint16_t)~(uint16_t)ITPendingBit);
...
3582  0000               L542:
3583  0000 2e2e5c737476  	dc.b	"..\stvd\cosmic\stm"
3584  0012 38735f737464  	dc.b	"8s_stdperiph_lib\l"
3585  0024 696272617269  	dc.b	"ibraries\stm8s_std"
3586  0036 706572697068  	dc.b	"periph_driver\src\"
3587  0048 73746d38735f  	dc.b	"stm8s_adc1.c",0
3607                     	end
