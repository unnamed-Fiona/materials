 ...
 587  011e 81            	ret
 610                     ; 168 void AWU_IdleModeEnable(void)
 610                     ; 169 {
 611                     	switch	.text
 612  011f               _AWU_IdleModeEnable:
 616                     ; 171   AWU->CSR &= (uint8_t)(~AWU_CSR_AWUEN);
 618  011f 721950f0      	bres	20720,#4
 619                     ; 174   AWU->TBR = (uint8_t)(~AWU_TBR_AWUTB);
 621  0123 35f050f2      	mov	20722,#240
 622                     ; 175 }
 625  0127 81            	ret
 669                     ; 183 FlagStatus AWU_GetFlagStatus(void)
 669                     ; 184 {
 670                     	switch	.text
 671  0128               _AWU_GetFlagStatus:
 675                     ; 185   return((FlagStatus)(((uint8_t)(AWU->CSR & AWU_CSR_AWUF) == (uint8_t)0x00) ? RESET : SET));
 ...
 731                     	switch	.const
 732  002e               L501:
 733  002e 2e2e5c737476  	dc.b	"..\stvd\cosmic\stm"
 734  0040 38735f737464  	dc.b	"8s_stdperiph_lib\l"
 735  0052 696272617269  	dc.b	"ibraries\stm8s_std"
 736  0064 706572697068  	dc.b	"periph_driver\src\"
 737  0076 73746d38735f  	dc.b	"stm8s_awu.c",0
 738                     	xref.b	c_lreg
 739                     	xref.b	c_x
 759                     	xref	c_imul
 760                     	xref	c_ludv
