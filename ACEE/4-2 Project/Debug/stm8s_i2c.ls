 ...
 445                     ; 133     if (I2C_DutyCycle == I2C_DUTYCYCLE_2)
 447  011e 0d12          	tnz	(OFST+9,sp)
 448  0120 2630          	jrne	L531
 449                     ; 136       result = (uint16_t) ((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz * 3));
 ...
 478  0152               L531:
 479                     ; 141       result = (uint16_t) ((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz * 25));
 ...
 532                     ; 157     I2C->TRISER = (uint8_t)tmpval;
 534  019d 7b06          	ld	a,(OFST-3,sp)
 535  019f c7521d        	ld	21021,a
 537  01a2 2043          	jra	L341
 538  01a4               L331:
 539                     ; 164     result = (uint16_t)((InputClockFrequencyMHz * 1000000) / (OutputClockFrequencyHz << (uint8_t)1));
 ...
 629  0220 81            	ret
 685                     ; 202 void I2C_Cmd(FunctionalState NewState)
 685                     ; 203 {
 686                     	switch	.text
 687  0221               _I2C_Cmd:
 689  0221 88            	push	a
 690       00000000      OFST:	set	0
 693                     ; 205   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 695  0222 4d            	tnz	a
 ...
 711  023c               L46:
 712                     ; 207   if (NewState != DISABLE)
 714  023c 0d01          	tnz	(OFST+1,sp)
 715  023e 2706          	jreq	L571
 716                     ; 210     I2C->CR1 |= I2C_CR1_PE;
 718  0240 72105210      	bset	21008,#0
 720  0244 2004          	jra	L771
 721  0246               L571:
 722                     ; 215     I2C->CR1 &= (uint8_t)(~I2C_CR1_PE);
 724  0246 72115210      	bres	21008,#0
 725  024a               L771:
 726                     ; 217 }
 729  024a 84            	pop	a
 730  024b 81            	ret
 766                     ; 225 void I2C_GeneralCallCmd(FunctionalState NewState)
 766                     ; 226 {
 767                     	switch	.text
 768  024c               _I2C_GeneralCallCmd:
 770  024c 88            	push	a
 771       00000000      OFST:	set	0
 774                     ; 228   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 776  024d 4d            	tnz	a
 ...
 792  0267               L47:
 793                     ; 230   if (NewState != DISABLE)
 795  0267 0d01          	tnz	(OFST+1,sp)
 796  0269 2706          	jreq	L712
 797                     ; 233     I2C->CR1 |= I2C_CR1_ENGC;
 799  026b 721c5210      	bset	21008,#6
 801  026f 2004          	jra	L122
 802  0271               L712:
 803                     ; 238     I2C->CR1 &= (uint8_t)(~I2C_CR1_ENGC);
 805  0271 721d5210      	bres	21008,#6
 806  0275               L122:
 807                     ; 240 }
 810  0275 84            	pop	a
 811  0276 81            	ret
 847                     ; 250 void I2C_GenerateSTART(FunctionalState NewState)
 847                     ; 251 {
 848                     	switch	.text
 849  0277               _I2C_GenerateSTART:
 851  0277 88            	push	a
 852       00000000      OFST:	set	0
 855                     ; 253   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 857  0278 4d            	tnz	a
 ...
 873  0292               L401:
 874                     ; 255   if (NewState != DISABLE)
 876  0292 0d01          	tnz	(OFST+1,sp)
 877  0294 2706          	jreq	L142
 878                     ; 258     I2C->CR2 |= I2C_CR2_START;
 880  0296 72105211      	bset	21009,#0
 882  029a 2004          	jra	L342
 883  029c               L142:
 884                     ; 263     I2C->CR2 &= (uint8_t)(~I2C_CR2_START);
 886  029c 72115211      	bres	21009,#0
 887  02a0               L342:
 888                     ; 265 }
 891  02a0 84            	pop	a
 892  02a1 81            	ret
 928                     ; 273 void I2C_GenerateSTOP(FunctionalState NewState)
 928                     ; 274 {
 929                     	switch	.text
 930  02a2               _I2C_GenerateSTOP:
 932  02a2 88            	push	a
 933       00000000      OFST:	set	0
 936                     ; 276   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
 938  02a3 4d            	tnz	a
 ...
 954  02bd               L411:
 955                     ; 278   if (NewState != DISABLE)
 957  02bd 0d01          	tnz	(OFST+1,sp)
 958  02bf 2706          	jreq	L362
 959                     ; 281     I2C->CR2 |= I2C_CR2_STOP;
 961  02c1 72125211      	bset	21009,#1
 963  02c5 2004          	jra	L562
 964  02c7               L362:
 965                     ; 286     I2C->CR2 &= (uint8_t)(~I2C_CR2_STOP);
 967  02c7 72135211      	bres	21009,#1
 968  02cb               L562:
 969                     ; 288 }
 972  02cb 84            	pop	a
 973  02cc 81            	ret
1010                     ; 296 void I2C_SoftwareResetCmd(FunctionalState NewState)
1010                     ; 297 {
1011                     	switch	.text
1012  02cd               _I2C_SoftwareResetCmd:
1014  02cd 88            	push	a
1015       00000000      OFST:	set	0
1018                     ; 299   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1020  02ce 4d            	tnz	a
...
1036  02e8               L421:
1037                     ; 301   if (NewState != DISABLE)
1039  02e8 0d01          	tnz	(OFST+1,sp)
1040  02ea 2706          	jreq	L503
1041                     ; 304     I2C->CR2 |= I2C_CR2_SWRST;
1043  02ec 721e5211      	bset	21009,#7
1045  02f0 2004          	jra	L703
1046  02f2               L503:
1047                     ; 309     I2C->CR2 &= (uint8_t)(~I2C_CR2_SWRST);
1049  02f2 721f5211      	bres	21009,#7
1050  02f6               L703:
1051                     ; 311 }
1054  02f6 84            	pop	a
1055  02f7 81            	ret
1092                     ; 320 void I2C_StretchClockCmd(FunctionalState NewState)
1092                     ; 321 {
1093                     	switch	.text
1094  02f8               _I2C_StretchClockCmd:
1096  02f8 88            	push	a
1097       00000000      OFST:	set	0
1100                     ; 323   assert_param(IS_FUNCTIONALSTATE_OK(NewState));
1102  02f9 4d            	tnz	a
...
1118  0313               L431:
1119                     ; 325   if (NewState != DISABLE)
1121  0313 0d01          	tnz	(OFST+1,sp)
1122  0315 2706          	jreq	L723
1123                     ; 328     I2C->CR1 &= (uint8_t)(~I2C_CR1_NOSTRETCH);
1125  0317 721f5210      	bres	21008,#7
1127  031b 2004          	jra	L133
1128  031d               L723:
1129                     ; 334     I2C->CR1 |= I2C_CR1_NOSTRETCH;
1131  031d 721e5210      	bset	21008,#7
1132  0321               L133:
1133                     ; 336 }
1136  0321 84            	pop	a
1137  0322 81            	ret
1174                     ; 345 void I2C_AcknowledgeConfig(I2C_Ack_TypeDef Ack)
1174                     ; 346 {
1175                     	switch	.text
1176  0323               _I2C_AcknowledgeConfig:
1178  0323 88            	push	a
1179       00000000      OFST:	set	0
1182                     ; 348   assert_param(IS_I2C_ACK_OK(Ack));
1184  0324 4d            	tnz	a
...
1440                     ; 408   assert_param(IS_I2C_DUTYCYCLE_OK(I2C_DutyCycle));
1442  03d0 4d            	tnz	a
...
1458  03ea               L271:
1459                     ; 410   if (I2C_DutyCycle == I2C_DUTYCYCLE_16_9)
1461  03ea 7b01          	ld	a,(OFST+1,sp)
1462  03ec a140          	cp	a,#64
1463  03ee 2606          	jrne	L734
1464                     ; 413     I2C->CCRH |= I2C_CCRH_DUTY;
1466  03f0 721c521c      	bset	21020,#6
1468  03f4 2004          	jra	L144
1469  03f6               L734:
1470                     ; 418     I2C->CCRH &= (uint8_t)(~I2C_CCRH_DUTY);
1472  03f6 721d521c      	bres	21020,#6
1473  03fa               L144:
1474                     ; 420 }
1477  03fa 84            	pop	a
1478  03fb 81            	ret
1501                     ; 427 uint8_t I2C_ReceiveData(void)
1501                     ; 428 {
1502                     	switch	.text
1503  03fc               _I2C_ReceiveData:
1507                     ; 430   return ((uint8_t)I2C->DR);
1509  03fc c65216        	ld	a,21014
1512  03ff 81            	ret
1578                     ; 440 void I2C_Send7bitAddress(uint8_t Address, I2C_Direction_TypeDef Direction)
1578                     ; 441 {
1579                     	switch	.text
1580  0400               _I2C_Send7bitAddress:
1582  0400 89            	pushw	x
1583       00000000      OFST:	set	0
1586                     ; 443   assert_param(IS_I2C_ADDRESS_OK(Address));
...
1602  0419               L202:
1603                     ; 444   assert_param(IS_I2C_DIRECTION_OK(Direction));
...
1636  0443 85            	popw	x
1637  0444 81            	ret
1671                     ; 458 void I2C_SendData(uint8_t Data)
1671                     ; 459 {
1672                     	switch	.text
1673  0445               _I2C_SendData:
1677                     ; 461   I2C->DR = Data;
1679  0445 c75216        	ld	21014,a
1680                     ; 462 }
1683  0448 81            	ret
1908                     ; 578 ErrorStatus I2C_CheckEvent(I2C_Event_TypeDef I2C_Event)
1908                     ; 579 {
1909                     	switch	.text
...
1917                     ; 580   __IO uint16_t lastevent = 0x00;
1919  044c 5f            	clrw	x
1920  044d 1f04          	ldw	(OFST-2,sp),x
1921                     ; 581   uint8_t flag1 = 0x00 ;
1923                     ; 582   uint8_t flag2 = 0x00;
1925                     ; 583   ErrorStatus status = ERROR;
1927                     ; 586   assert_param(IS_I2C_EVENT_OK(I2C_Event));
...
1989  04d2               L222:
1990                     ; 588   if (I2C_Event == I2C_EVENT_SLAVE_ACK_FAILURE)
1992  04d2 1e07          	ldw	x,(OFST+1,sp)
1993  04d4 a30004        	cpw	x,#4
1994  04d7 260b          	jrne	L336
1995                     ; 590     lastevent = I2C->SR2 & I2C_SR2_AF;
...
2004  04e4               L336:
2005                     ; 594     flag1 = I2C->SR1;
2007  04e4 c65217        	ld	a,21015
2008  04e7 6b03          	ld	(OFST-3,sp),a
2009                     ; 595     flag2 = I2C->SR3;
2011  04e9 c65219        	ld	a,21017
2012  04ec 6b06          	ld	(OFST+0,sp),a
2013                     ; 596     lastevent = ((uint16_t)((uint16_t)flag2 << (uint16_t)8) | (uint16_t)flag1);
...
2030  0503               L536:
2031                     ; 599   if (((uint16_t)lastevent & (uint16_t)I2C_Event) == (uint16_t)I2C_Event)
...
2399                     ; 683   FlagStatus bitstatus = RESET;
2401                     ; 686   assert_param(IS_I2C_FLAG_OK(I2C_Flag));
...
2447  05b7               L432:
2448                     ; 689   regindex = (uint8_t)((uint16_t)I2C_Flag >> 8);
2450  05b7 7b03          	ld	a,(OFST+1,sp)
2451  05b9 6b01          	ld	(OFST-1,sp),a
2452                     ; 691   switch (regindex)
...
2464  05c8               L576:
2465                     ; 694     case 0x01:
2465                     ; 695       tempreg = (uint8_t)I2C->SR1;
...
2472  05cf               L776:
2473                     ; 699     case 0x02:
2473                     ; 700       tempreg = (uint8_t)I2C->SR2;
...
2480  05d6               L107:
2481                     ; 704     case 0x03:
2481                     ; 705       tempreg = (uint8_t)I2C->SR3;
...
2603                     ; 768   I2C->SR2 = (uint8_t)((uint16_t)(~flagpos));
...
2612  0625 81            	ret
2779                     ; 791 ITStatus I2C_GetITStatus(I2C_ITPendingBit_TypeDef I2C_ITPendingBit)
2779                     ; 792 {
2780                     	switch	.text
...
2788                     ; 793   ITStatus bitstatus = RESET;
2790                     ; 794   __IO uint8_t enablestatus = 0;
...
2912  06cf 81            	ret
2958                     ; 871 void I2C_ClearITPendingBit(I2C_ITPendingBit_TypeDef I2C_ITPendingBit)
2958                     ; 872 {
2959                     	switch	.text
...
2993  06fe               L262:
2994                     ; 879   flagpos = (uint16_t)I2C_ITPendingBit & FLAG_Mask;
...
3004                     ; 882   I2C->SR2 = (uint8_t)((uint16_t)~flagpos);
...
3047                     	switch	.const
3048  000c               L131:
3049  000c 2e2e5c737476  	dc.b	"..\stvd\cosmic\stm"
3050  001e 38735f737464  	dc.b	"8s_stdperiph_lib\l"
3051  0030 696272617269  	dc.b	"ibraries\stm8s_std"
3052  0042 706572697068  	dc.b	"periph_driver\src\"
3053  0054 73746d38735f  	dc.b	"stm8s_i2c.c",0
3054                     	xref.b	c_lreg
3055                     	xref.b	c_x
3075                     	xref	c_sdivx
3076                     	xref	c_ludv
